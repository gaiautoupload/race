...
export default function Home() {
  return <>
    <main className="race">
      ...
      <section className="stock-search"><label htmlFor="stock-search">個股查詢</label><input id="stock-search" type="search" placeholder="輸入興櫃代號或名稱，例如 6696、仁新" autoComplete="off" /><small>顯示均價、前 10 大主力與今日前 20 大買賣表</small></section>
      <section id="stock-result" className="stock-result"></section>
